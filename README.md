...
| Directory | Purpose | README |
| --------- | ------- | ------ |
| `01-windows-image_builder_working` | Windows image build pipeline with VirtIO drivers | — |
...
| `03-sample-windows-packer` | Windows qcow2 with optional swtpm (software TPM), curtin hooks, and standalone swtpm lifecycle script | [README](06-packer/03-sample-windows-packer/README.md) |
